...
public final class MbotUsedHardwareCollectorWorker implements IWorker {
    ...
    public String getName() {
        return "MbotUsedHardwareCollector";
    }

    @Override
    public void execute(Project project) {
        final MbotUsedHardwareCollectorVisitor visitor = new MbotUsedHardwareCollectorVisitor(project.getProgramAst().getTree(), project.getConfigurationAst());
