...
public final class Bob3UsedHardwareCollectorWorker implements IWorker {
    private static final Logger LOG = LoggerFactory.getLogger(Bob3UsedHardwareCollectorWorker.class);

    @Override
    public String getName() {
        return "Bob3UsedHardwareCollector";
    }

    @Override
    public void execute(Project project) {
        final Bob3UsedHardwareCollectorVisitor visitor = new Bob3UsedHardwareCollectorVisitor(project.getProgramAst().getTree());
