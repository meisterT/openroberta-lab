...
public class Bob3TemperatureSensorTest extends AstTest {
    ...
    public void getLeftArmRightArmLight() throws Exception {
        ...
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, a, "/ast/sensors/sensor_bob3Temperature.xml");
    }
}
