...
public class PythonVisitorTest extends AstTest {

    @Test
    public void visitSoundSensorTest() throws Exception {
        String expectedResult = "item=Trueitem=Ed.ReadClapSensor()==Ed.CLAP_DETECTED";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/sensor/sound_sensor.xml");
    }
    ...
    public void visitDriveActionTest() throws Exception {
        ...
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/actor/drive_1.xml");

        expectedResult = "_diffDrive(Ed.BACKWARD,33,22)";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/actor/drive_2.xml");
    }

    @Test
    public void visitMathOnListFunctTest() throws Exception {
        String expectedResult = "item=Ed.List(3,[1,2,3])\n" + "item2=0\n" + "item2=sum(item)";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/math/math_on_list.xml");
    }
    ...
    public void visitMainTaskTest() throws Exception {
        ...
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/task/start.xml");
    }
    ...
    public void visitMathNumPropFunctTest() throws Exception {
        ...
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/math/num_prop_1.xml");

        //odd
        expectedResult = "item=True\n\nitem=(42%2)==1";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/math/num_prop_2.xml");

        //prime
        expectedResult = "item=True\n\nitem=_isPrime(42)";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/math/num_prop_3.xml");

        //positive
        expectedResult = "item=True\n\nitem=42>0";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/math/num_prop_4.xml");

        //negative
        expectedResult = "item=True\n\nitem=42<0";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/math/num_prop_5.xml");

        //divisible by
        expectedResult = "item=True\n\nitem=(42%13)==0";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/math/num_prop_6.xml");
    }

    @Test
    public void visitListCreateTest() throws Exception {
        String expectedResult = "item=Ed.List(4,[5,3,0,4])";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/lists/list_create.xml");
    }

    @Test
    public void visitKeysSensorTest() throws Exception {
        String expectedResult = "item=True\n\nitem=Ed.ReadKeypad()==Ed.KEYPAD_ROUND\nitem=Ed.ReadKeypad()==Ed.KEYPAD_TRIANGLE";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/sensor/keys.xml");
    }
    ...
    public void visitSensorResetTest() throws Exception {
        ...
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/sensor/reset.xml");
    }
    ...
    public void visitInfraredSensorTest() throws Exception {
        ...
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/sensor/infrared.xml");
    }

    @Test
    public void visitIRSeekerSensorTest() throws Exception {
        String expectedResult = "item=0item=_irSeek(1)";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/sensor/irseeker.xml");
    }
    ...
    public void visitLightSensorTest() throws Exception {
        ...
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/sensor/light.xml");
    }
    ...
    public void visitSensorWaitUntilTest() throws Exception {
        ...
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/sensor/wait.xml");
    }

    @Test
    public void visitCurveActionTest() throws Exception {
        String expectedResult = "_diffCurve(Ed.BACKWARD,42,69,17)";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/actor/steer.xml");
    }
    ...
    public void visitCurveActionUnlimitedTest() throws Exception {
        ...
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/actor/steer_unlimited.xml");
    }

    @Test
    public void visitTurnActionTest() throws Exception {
        String expectedResult = "_diffTurn(Ed.SPIN_RIGHT,42,13)";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/actor/turn.xml");
    }
    ...
    public void visitTurnActionUnlimitedTest() throws Exception {
        ...
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/actor/turn_unlimited.xml");
    }

    @Test
    public void visitMotorOnTest() throws Exception {
        String expectedResult = "_motorOn(0,23,Ed.DISTANCE_UNLIMITED)";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/actor/motor_on.xml");
    }

    @Test
    public void visitMotorStopTest() throws Exception {
        String expectedResult = "Ed.DriveRightMotor(Ed.STOP,Ed.SPEED_1,1)";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/actor/motor_stop.xml");
    }

    @Test
    public void visitMotorDriveStopTest() throws Exception {
        String expectedResult = "Ed.Drive(Ed.STOP,Ed.SPEED_1,1)";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/actor/motor_drive_stop.xml");
    }

    @Test
    public void visitLengthOfIsEmptyFunctTest() throws Exception {
        String expectedResult = "item=len(Ed.List(0,[]))";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/lists/length_of_is_empty.xml");
    }

    @Test
    public void visitWaitTimeStmtTest() throws Exception {
        String expectedResult = "Ed.TimeWait(234,Ed.TIME_MILLISECONDS)";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/task/wait_time_stmt.xml");
    }

    @Test
    public void visitListGetIndexTest() throws Exception {
        String expectedResult = "item=Ed.List(1,[-30])item2=0item2=item[0]";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/lists/get_index.xml");
    }

    @Test
    public void visitListSetIndexTest() throws Exception {
        String expectedResult = "item=Ed.List(2,[3,9])\n\nitem[1]=7";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/lists/set_index.xml");
    }

    @Test
    public void visitLightActionTest() throws Exception {
        String expectedResult = "Ed.RightLed(Ed.ON)";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/actor/light_action.xml");
    }

    @Test
    public void visitLightStatusActionTest() throws Exception {
        String expectedResult = "Ed.RightLed(Ed.OFF)";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/actor/light_status_action.xml");
    }
    ...
    public void visitToneActionTest() throws Exception {
        ...
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/actor/tone_action.xml");
    }
    ...
    public void visitPlayNoteActionTest() throws Exception {
        ...
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/actor/play_note_action.xml");
    }
    ...
    public void visitPlayFileActionTest() throws Exception {
        String expectedResult =
            "___soundfile5=Ed.TuneString(55,\"c4d4e4f4g2g2a4a4a4a4g2R2a4a4a4a4g2f4f4f4e2e2g4g4g4g4c1z\")"
                ...
                + "pass";
        UnitTestHelper.checkGeneratedSourceEqualityWithSourceAsString(testFactory, expectedResult, "/syntax/actor/play_file_action.xml");
    }
}
