...
public class HelperEdisonForXmlTest extends AbstractHelperForXmlTest {
    ...
    public HelperEdisonForXmlTest() {
        super(new EdisonFactory(new PluginProperties("edison", "", "", Util1.loadProperties("classpath:/edison.properties"))), makeConfig());
    }
    ...
    private String generatePythonWithoutWrapping(String pathToProgramXml) throws Exception {
        ...
        String code =
            EdisonPythonVisitor.generate(this.getRobotConfiguration(), transformer.getTree(), false, this.getRobotFactory().getHelperMethodGenerator());
        return code;
    }
    ...
    public String generatePython(String pathToProgramXml) throws Exception {
        Jaxb2ProgramAst<Void> transformer = generateTransformer(pathToProgramXml);
        String code =
            EdisonPythonVisitor.generate(this.getRobotConfiguration(), transformer.getTree(), true, this.getRobotFactory().getHelperMethodGenerator());
        return code;
    }
