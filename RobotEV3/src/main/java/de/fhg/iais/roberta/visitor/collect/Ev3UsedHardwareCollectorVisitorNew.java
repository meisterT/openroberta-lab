 ...
 * @author kcvejoski
 */
public final class Ev3UsedHardwareCollectorVisitorNew extends AbstractUsedHardwareCollectorVisitor implements IEv3Visitor<Void> {
    private final Set<String> usedImages = new HashSet<>();

    private boolean isSayTextUsed = false;

    public Ev3UsedHardwareCollectorVisitorNew(ConfigurationAst configuration) {
        super(configuration);
    }
